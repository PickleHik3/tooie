...
func runThemeApplyCommand(args []string) int {
	...
	meta["widget_poll_seconds"] = strconv.Itoa(normalizeWidgetPollSeconds(cfg.WidgetPollSec))
...
func computeThemePayload(cfg themeApplyConfig, workDir string) (computedPayload, []byte, error) {
	...
	out.Meta["widget_poll_seconds"] = strconv.Itoa(normalizeWidgetPollSeconds(cfg.WidgetPollSec))
...
func parseThemeApplyFlags(args []string) (themeApplyConfig, error) {
	...
	widgetStorage := "on"
	widgetWeather := "on"
	widgetPollSeconds := strconv.Itoa(defaultWidgetPoll)
	...
	fs.StringVar(&widgetPollSeconds, "widget-poll-seconds", widgetPollSeconds, "")
	...
	cfg.WidgetPollSec = parseWidgetPollSeconds(widgetPollSeconds, defaultWidgetPoll)
	return cfg, nil
}
